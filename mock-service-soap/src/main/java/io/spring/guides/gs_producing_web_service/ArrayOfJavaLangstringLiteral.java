 ...
 *       &lt;sequence>
 *         &lt;element name="Perfil" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfJavaLangstringLiteral {
    ...
    @XmlElement(name = "Perfil", nillable = true)
    protected List<String> perfil;
